...
export function PetForm({ action, cancelHref, defaultValues }: PetFormProps) {
  ...
  return (
    <form action={formAction} className="space-y-4 max-w-lg">
      ...
      <div className="space-y-1">
        <Label htmlFor="species">物種</Label>
        <Select name="species" defaultValue={defaultValues?.species ?? "dog"} items={Object.fromEntries(PET_SPECIES.map((s) => [s.value, s.label]))}>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-1">
          ...
          <Select name="sex" defaultValue={defaultValues?.sex ?? ""} items={Object.fromEntries(PET_SEX.map((s) => [s.value, s.label]))}>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          <Label htmlFor="motherChipNumber">親代晶片號碼</Label>
